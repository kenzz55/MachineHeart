...
#include "Behaviors/MHNormalGuardAtk5.h"
#include "Kismet/GameplayStatics.h"
#include "Character/MHCharacterBase.h"
#include "Character/MHCharacterEnemy.h"
#include "Character/MHCharacterPlayer.h"

void UMHNormalGuardAtk5::ExecuteBehavior_Implementation(AMHCharacterEnemy* Enemy, AMHBattleGameMode* GM)
{
    if (!Enemy) return;
    ...
    if (auto* Player = Cast<AMHCharacterPlayer>(UGameplayStatics::GetPlayerCharacter(Enemy, 0)))
    {
        ...
        Player->ReceiveBattleDamageFromEnemy(Enemy, /*bUseBonus=*/true, /*Bonus=*/5.f);
        return;
    }
